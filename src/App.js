...
import { ADD_DEMON_URL, DELETE_DEMON_URL, DEMON_LIST_URL, DEMON_URL, HOME_URL, MODIFY_DEMON_URL } from './Constants/urls';
...
import DeleteDemonView from './Views/DeleteDemonView';
      ...
      <BrowserRouter>
        ...
        <main className='w-full h-[85%] flex'>
          <Routes>
            ...
            <Route path={DELETE_DEMON_URL} element={<DeleteDemonView />} />
          </Routes>
        </main>
      </BrowserRouter>
    </>
