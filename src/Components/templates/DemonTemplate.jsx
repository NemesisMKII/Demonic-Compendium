...
import DemonResistanceInfo from "../utils/DemonResistanceInfo";

const DemonTemplate = ({lvlDiv, infoDiv, conditionDiv, resDiv, statsDiv, button = null, resHoverData = ""}) => {
    ...
    return (
        <>
            <div className="h-full w-1/3">
                ...
                <div className="p-2">
                    ...
                    <div className="w-full flex space-x-2">
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["phys"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["fire"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["ice"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["thunder"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["force"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["light"]} />
                        <img alt="" className="boxStatsShadow p-1 w-16 h-16" src={elements["dark"]} />
                    </div>
                    <div className="w-full flex space-x-2">
                        {resDiv}
                    </div>
            ...
            <div className="h-full w-1/3 space-y-5">
                <img alt="" className="m-auto h-[90%]" src={unknownDemonImg} />
                {button}
            </div>
